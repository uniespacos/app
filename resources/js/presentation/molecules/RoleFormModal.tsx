        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-h-[90vh] max-w-5xl overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>{role ? 'Atualize os detalhes do papel' : 'Crie um novo papel customizado'}</DialogDescription>
                </DialogHeader>
                    ...
                    <div className="space-y-5">
                        <div className="space-y-2">
                            ...
                            <Controller
                                ...
                                control={control}
                                render={({ field }) => (
                                    <Input id="name" {...field} placeholder="ex: secretaria-academica" disabled={role?.is_system} />
                                )}
                            />
